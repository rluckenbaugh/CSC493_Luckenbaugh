...
public class Level {
	...
	{
		EMPTY(0,0,0), //black
		ROCK(102, 188, 69), // green
		PLAYER_SPAWNPOINT(255,255,255), //white
		ITEM_BEE(170,117, 178), //purple
		ITEM_TREAT(239, 234, 21),//yellow;
		ITEM_PILE(110, 202, 200), //teal
		ITEM_HOUSE(255,255,255),
		ITEM_BONE(237,31,36); //white 
	...
	private void init(String filename)
	{
		...
		for (int pixelY = 0; pixelY < pixmap.getHeight(); pixelY++)
		{
			for(int pixelX = 0; pixelX<pixmap.getWidth(); pixelX++)
			{
				...
				if (BLOCK_TYPE.ITEM_HOUSE.sameColor(currentPixel))
				{}
